...
::
    ...
    class xmlformatter.Formatter(compress ::= False, indent ::= 2, indent_char ::= " ", inline ::= True, encoding_input ::= None, encoding_output ::= None, preserve ::= [ ], blanks ::= False)
...
::
    ...
    xmlformat [--preserve "pre,literal"] [--blanks] [--compress] [--indent num] [--indent-char char]
